...
def create_petition(ad_soyad, ogrenci_no, cep_telefonu, eposta, egitim_yili, yariyil, dersler):
    ...
    metin = (f"{egitim_yili} Eğitim-Öğretim yılı {yariyil} Yarıyılında daha önce alıp, F0 dışında bir not ile başarısız"
...
def form_gonder():
    ...
    for i in range(max_dersler):
        ...
        if any([kodu1, adi1, kodu2, adi2, grubu]):  # Check if any field is non-empty
